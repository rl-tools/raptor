        ...
        with open(f"vicon_data_{self.object_name}.csv", 'w', newline='') as csvfile:
            ...
            for record in self.data_records:
                if record is not None:
                    timestamp, frame, frame_dt, (x, y, z), euler_x, euler_y, euler_z, qx, qy, qz, qw, (vx, vy, vz) = record
                    writer.writerow([frame, timestamp, frame_dt, x, y, z, euler_x, euler_y, euler_z, qw, qx, qy, qz, vx, vy, vz])
